"""This script inputs the JSON files generated by evaluated_games_extractor.py and outputs a CSV file
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print("Usage: python json_to_csv_converter.py <json_dir> <csv_output_dir>")
        sys.exit(1)
